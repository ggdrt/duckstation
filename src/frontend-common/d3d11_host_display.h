...
protected:
  ...
  void RenderDisplay(float left, float top, float width, float height, void* texture_handle, u32 texture_width,
  ...
  void ApplyPostProcessingChain(ID3D11RenderTargetView* final_target, float final_left, float final_top,
                                float final_width, float final_height, void* texture_handle, u32 texture_width,
                                s32 texture_height, s32 texture_view_x, s32 texture_view_y, s32 texture_view_width,
