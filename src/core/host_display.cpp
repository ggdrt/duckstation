...
void HostDisplay::CalculateDrawRect(s32 window_width, s32 window_height, float* out_left, float* out_top, float* out_width,
                                                                      ...
                                                                      bool apply_aspect_ratio /* = true */) const
{
  ...
  return std::make_tuple(left + left_padding, top + top_padding + static_cast<float>(top_margin), width, height);
}
